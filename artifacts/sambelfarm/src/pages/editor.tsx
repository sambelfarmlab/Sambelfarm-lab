...
export default function EditorPage() {
  ...
  const handleToneChange = (newTone: string) => {
    ...
    notionUpdate.mutate(
      ...
      {
        onSuccess: () => toast({ title: "Tone diperbarui" }),
        onError: () =>
                        ...
                        >
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-2">
                              ...
                              {statusRevisi && (
                                <Badge
                                  variant="outline"
                                  className={`text-[10px] px-1.5 h-5 ${statusRevisi === "Final" || statusRevisi === "Dipublikasi" ? "bg-primary/10 text-primary border-primary/20" : statusRevisi === "Terjadwal" ? "bg-accent/10 text-accent border-accent/20" : ""}`}
                                >
                                  {statusRevisi}
                                </Badge>
                              )}
                          ...
                          <div className="flex flex-wrap gap-1.5 pt-1">
                            <Button
                              size="sm"
                              variant="outline"
                              className="flex-1 min-w-[80px] h-8 px-2 text-[10px] sm:text-xs"
                            ...
                            >
                              <Edit3 size={10} className="mr-1 shrink-0" />
                              Buka Editor
                            </Button>
                            <Button
                              size="sm"
                            ...
                            >
                              <Sparkles size={10} className="mr-1 shrink-0" />
                              Tulis Ulang
                            </Button>
                          </div>
                        </div>
